...
// G4bool PassiveProtonBeamLine::CalculationDone = false;
/////////////////////////////////////////////////////////////////////////////
BESTPassiveProtonBeamLine::BESTPassiveProtonBeamLine()
  : modulator(0),
    ...
    BESTfirstScatteringFoil(0),
    physiBESTFirstScatteringFoil(0),
    physiBESTKaptonWindow(0),
    solidBESTStopper(0),
    physiBESTStopper(0),
    BESTsecondScatteringFoil(0),
    physiBESTSecondScatteringFoil(0),
    physiBESTFirstCollimator(0),
    solidBESTRangeShifterBox(0),
    logicBESTRangeShifterBox(0),
    physiBESTRangeShifterBox(0),
    physiBESTSecondCollimator(0),
    physiBESTFirstCollimatorModulatorBox(0),
    physiBESTHoleFirstCollimatorModulatorBox(0),
    physiBESTSecondCollimatorModulatorBox(0),
    physiBESTHoleSecondCollimatorModulatorBox(0),
    chamberPhys(0),
    innerchamberPhys(0),
    enterWindowPhys(0),
    enterElectrodePhys(0),
    kaptonLayerPhys1(0),
    copperLayerPhys1(0),
    nickelLayerPhys1(0),
    fFirstCavityPhys(0),
    centralElectrode1Phys(0),
    centralWindowPhys(0),
    centralElectrode2Phys(0),
    fSecondCavityPhys(0),
    exitElectrodePhys(0),
    kaptonLayerPhys2(0),
    copperLayerPhys2(0),
...
G4VPhysicalVolume* BESTPassiveProtonBeamLine::Construct()
{
  ...
  if (!hadrontherapyDetectorConstruction)
    ...
    hadrontherapyDetectorConstruction =
      new HadrontherapyDetectorConstruction(physicalTreatmentRoom);
...
void BESTPassiveProtonBeamLine::SetDefaultDimensions()
{
  ...
  G4double defaultBESTSecondScatteringFoilXPosition =
    defaultBESTStopperXPosition + defaultBESTHeightStopper + defaultBESTSecondScatteringFoilXSize;
  ...
  G4Material* nichelNistAsMaterial =
    G4NistManager::Instance()->FindOrBuildMaterial("G4_Ni", isotopes);
...
void BESTPassiveProtonBeamLine::ConstructBESTPassiveProtonBeamLine()
{
  ...
  G4LogicalVolume* logicTreatmentRoom =
    new G4LogicalVolume(treatmentRoom, airNist, "logicTreatmentRoom", 0, 0, 0);
...
void BESTPassiveProtonBeamLine::BESTBeamLineSupport()
{
  ...
  physiBeamLineSupport = new G4PVPlacement(
    ...
    "BeamLineSupport", logicBeamLineSupport, physicalTreatmentRoom, false, 0);
  ...
  G4LogicalVolume* logicBeamLineCover =
    new G4LogicalVolume(beamLineCover, beamLineSupportMaterial, "BeamLineCover");

  physiBeamLineCover = new G4PVPlacement(
    0, G4ThreeVector(beamLineCoverXPosition, beamLineCoverYPosition, beamLineCoverZPosition),
    "BeamLineCover", logicBeamLineCover, physicalTreatmentRoom, false, 0);
  ...
  physiBeamLineCover2 = new G4PVPlacement(
    0, G4ThreeVector(beamLineCoverXPosition, beamLineCoverYPosition, -beamLineCoverZPosition),
    "BeamLineCover2", logicBeamLineCover, physicalTreatmentRoom, false, 0);
...
void BESTPassiveProtonBeamLine::BESTBeamScatteringFoils()
{
  ...
  // The PIPE contains the FIRST SCATTERING FOIL and the KAPTON WINDOW
  G4Box* BESTvacuumZone =
    new G4Box("VacuumZone", BESTvacuumZoneXSize, BESTvacuumZoneYSize, BESTvacuumZoneZSize);
  G4LogicalVolume* logicBESTVacuumZone =
    new G4LogicalVolume(BESTvacuumZone, vacuumZoneMaterial, "VacuumZone");
  G4VPhysicalVolume* physiBESTVacuumZone =
    new G4PVPlacement(0, G4ThreeVector(BESTvacuumZoneXPosition, 0., 0.), "VacuumZone",
                      logicBESTVacuumZone, physicalTreatmentRoom, false, 0);
  // --------------------------//
  // THE FIRST SCATTERING FOIL //
  // --------------------------//
  // A thin foil performing a first scattering
  // of the original beam
  BESTfirstScatteringFoil = new G4Box("FirstScatteringFoil", BESTfirstScatteringFoilXSize,
                                      BESTfirstScatteringFoilYSize, BESTfirstScatteringFoilZSize);

  G4LogicalVolume* logicBESTFirstScatteringFoil = new G4LogicalVolume(
    BESTfirstScatteringFoil, firstScatteringFoilMaterial, "FirstScatteringFoil");

  physiBESTFirstScatteringFoil = new G4PVPlacement(
    0, G4ThreeVector(BESTfirstScatteringFoilXPosition, 0., 0.), "FirstScatteringFoil",
    logicBESTFirstScatteringFoil, physiBESTVacuumZone, false, 0);
  ...
  G4Box* solidBESTKaptonWindow = new G4Box("BESTKaptonWindow", BESTkaptonWindowXSize,
                                           BESTkaptonWindowYSize, BESTkaptonWindowZSize);

  G4LogicalVolume* logicBESTKaptonWindow =
    new G4LogicalVolume(solidBESTKaptonWindow, kaptonWindowMaterial, "BESTKaptonWindow");

  physiBESTKaptonWindow =
    new G4PVPlacement(0, G4ThreeVector(BESTkaptonWindowXPosition, 0., 0.), "BESTKaptonWindow",
                      logicBESTKaptonWindow, physiBESTVacuumZone, false, 0);
  ...
  solidBESTStopper = new G4Tubs("Stopper", BESTinnerRadiusStopper, BESTouterRadiusStopper,
                                BESTheightStopper, BESTstartAngleStopper, BESTspanningAngleStopper);

  logicBESTStopper = new G4LogicalVolume(solidBESTStopper, stopperMaterial, "Stopper", 0, 0, 0);

  physiBESTStopper =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(BESTstopperXPosition, BESTstopperYPosition,
                                                      BESTstopperZPosition)),
                      "BESTStopper", logicBESTStopper, physicalTreatmentRoom, false, 0);
  ...
  BESTsecondScatteringFoil =
    new G4Box("SecondScatteringFoil", BESTsecondScatteringFoilXSize, BESTsecondScatteringFoilYSize,
              BESTsecondScatteringFoilZSize);

  G4LogicalVolume* logicBESTSecondScatteringFoil = new G4LogicalVolume(
    BESTsecondScatteringFoil, secondScatteringFoilMaterial, "SecondScatteringFoil");

  physiBESTSecondScatteringFoil = new G4PVPlacement(
    0,
    G4ThreeVector(BESTsecondScatteringFoilXPosition, BESTsecondScatteringFoilYPosition,
                  BESTsecondScatteringFoilZPosition),
    "SeconScatteringFoil", logicBESTSecondScatteringFoil, physicalTreatmentRoom, false, 0);
...
void BESTPassiveProtonBeamLine::BESTRangeShifter()
{
  ...
  solidBESTRangeShifterBox = new G4Box("RangeShifterBox", BESTrangeShifterXSize,
                                       BESTrangeShifterYSize, BESTrangeShifterZSize);

  logicBESTRangeShifterBox =
    new G4LogicalVolume(solidBESTRangeShifterBox, rangeShifterMaterial, "RangeShifterBox");
  physiBESTRangeShifterBox =
    new G4PVPlacement(0, G4ThreeVector(BESTrangeShifterXPosition, 0., 0.), "RangeShifterBox",
                      logicBESTRangeShifterBox, physicalTreatmentRoom, false, 0);
...
void BESTPassiveProtonBeamLine::BESTBeamCollimators()
{
  ...
  G4Box* solidBESTFirstCollimator =
    new G4Box("FirstCollimator", firstCollimatorXSize, firstCollimatorYSize, firstCollimatorZSize);

  G4LogicalVolume* logicBESTFirstCollimator =
    new G4LogicalVolume(solidBESTFirstCollimator, firstCollimatorMaterial, "FirstCollimator");

  physiBESTFirstCollimator = new G4PVPlacement(
    0, G4ThreeVector(firstCollimatorXPosition, firstCollimatorYPosition, firstCollimatorZPosition),
    "FirstCollimator", logicBESTFirstCollimator, physicalTreatmentRoom, false, 0);
  // ----------------------------//
  ...
  G4Tubs* solidBESTHoleFirstCollimator = new G4Tubs(
    "HoleFirstCollimator", innerRadiusHoleFirstCollimator, outerRadiusHoleFirstCollimator,
    hightHoleFirstCollimator, startAngleHoleFirstCollimator, spanningAngleHoleFirstCollimator);

  G4LogicalVolume* logicBESTHoleFirstCollimator = new G4LogicalVolume(
    solidBESTHoleFirstCollimator, holeFirstCollimatorMaterial, "HoleFirstCollimator", 0, 0, 0);
  G4double phi = 90. * deg;
  // Matrix definition for a 90 deg rotation. Also used for other volumes
  G4RotationMatrix rm;
  rm.rotateY(phi);

  physiBESTHoleFirstCollimator =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector()), "HoleFirstCollimator",
                      logicBESTHoleFirstCollimator, physiBESTFirstCollimator, false, 0);
  // ------------------//
  // SECOND COLLIMATOR //
  //-------------------//
  // It is a slab of PMMA with an hole in its center
  ...
  physiBESTSecondCollimator = new G4PVPlacement(
    0,
    G4ThreeVector(secondCollimatorXPosition, secondCollimatorYPosition, secondCollimatorZPosition),
    "SecondCollimator", logicBESTFirstCollimator, physicalTreatmentRoom, false, 0);

  // ------------------------------//
  // Hole of the second collimator //
  // ------------------------------//
  physiBESTHoleSecondCollimator =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector()), "HoleSecondCollimator",
                      logicBESTHoleFirstCollimator, physiBESTSecondCollimator, false, 0);
  ...
  G4Box* solidBESTFirstCollimatorModulatorBox =
    new G4Box("FirstCollimatorModulatorBox", firstCollimatorModulatorXSize,
              firstCollimatorModulatorYSize, firstCollimatorModulatorZSize);

  G4LogicalVolume* logicBESTFirstCollimatorModulatorBox = new G4LogicalVolume(
    solidBESTFirstCollimatorModulatorBox, modulatorBoxMaterial, "FirstCollimatorModulatorBox");

  physiBESTFirstCollimatorModulatorBox = new G4PVPlacement(
    0,
    G4ThreeVector(firstCollimatorModulatorXPosition, firstCollimatorModulatorYPosition,
                  firstCollimatorModulatorZPosition),
    "FirstCollimatorModulatorBox", logicBESTFirstCollimatorModulatorBox, physicalTreatmentRoom,
    false, 0);
  ...
  G4Tubs* solidBESTHoleFirstCollimatorModulatorBox = new G4Tubs(
    "HoleFirstCollimatorModulatorBox", innerRadiusHoleFirstCollimatorModulatorBox,
    outerRadiusHoleFirstCollimatorModulatorBox, hightHoleFirstCollimatorModulatorBox,
    startAngleHoleFirstCollimatorModulatorBox, spanningAngleHoleFirstCollimatorModulatorBox);

  G4LogicalVolume* logicBESTHoleFirstCollimatorModulatorBox =
    new G4LogicalVolume(solidBESTHoleFirstCollimatorModulatorBox, holeModulatorBoxMaterial,
                        "HoleFirstCollimatorModulatorBox", 0, 0, 0);

  physiBESTHoleFirstCollimatorModulatorBox = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector()), "HoleFirstCollimatorModulatorBox",
    logicBESTHoleFirstCollimatorModulatorBox, physiBESTFirstCollimatorModulatorBox, false, 0);
  ...
  G4Box* solidBESTSecondCollimatorModulatorBox =
    new G4Box("SecondCollimatorModulatorBox", secondCollimatorModulatorXSize,
              secondCollimatorModulatorYSize, secondCollimatorModulatorZSize);

  G4LogicalVolume* logicBESTSecondCollimatorModulatorBox = new G4LogicalVolume(
    solidBESTSecondCollimatorModulatorBox, modulatorBoxMaterial, "SecondCollimatorModulatorBox");

  physiBESTSecondCollimatorModulatorBox = new G4PVPlacement(
    0,
    G4ThreeVector(secondCollimatorModulatorXPosition, secondCollimatorModulatorYPosition,
                  secondCollimatorModulatorZPosition),
    "SecondCollimatorModulatorBox", logicBESTSecondCollimatorModulatorBox, physicalTreatmentRoom,
    false, 0);
  ...
  G4Tubs* solidBESTHoleSecondCollimatorModulatorBox = new G4Tubs(
    "HoleSecondCollimatorModulatorBox", innerRadiusHoleSecondCollimatorModulatorBox,
    outerRadiusHoleSecondCollimatorModulatorBox, hightHoleSecondCollimatorModulatorBox,
    startAngleHoleSecondCollimatorModulatorBox, spanningAngleHoleSecondCollimatorModulatorBox);

  G4LogicalVolume* logicHBESToleSecondCollimatorModulatorBox =
    new G4LogicalVolume(solidBESTHoleSecondCollimatorModulatorBox, holeModulatorBoxMaterial,
                        "HoleSecondCollimatorModulatorBox", 0, 0, 0);

  physiBESTHoleSecondCollimatorModulatorBox = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector()), "HoleSecondCollimatorModulatorBox",
    logicHBESToleSecondCollimatorModulatorBox, physiBESTSecondCollimatorModulatorBox, false, 0);
...
void BESTPassiveProtonBeamLine::BESTBeamMonitoring()
{
  ...
  G4Box* chamberSolid =
    new G4Box(name, fBoxOuterWidth / 2, fBoxOuterHeight / 2, fBoxOuterThickness / 2);
  G4LogicalVolume* chamberLog = new G4LogicalVolume(chamberSolid, wallMaterial, name);
  chamberPhys = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(monitor1XPosition - 10 * cm, 0. * cm, 0. * cm)), name,
    chamberLog, physicalTreatmentRoom, false, 0);
  // chamberLog->SetVisAttributes(green);

  name = "monitorChamber-innerBox";

  G4Box* innerchamberSolid =
    new G4Box(name, fBoxInnerWidth / 2, fBoxInnerHeight / 2, fBoxInnerThickness / 2);
  G4LogicalVolume* innerchamberLog = new G4LogicalVolume(innerchamberSolid, CavityMaterial, name);
  innerchamberPhys =
    new G4PVPlacement(0, G4ThreeVector(0, 0, 0), name, innerchamberLog, chamberPhys, false, 0);
  // innerchamberLog->SetVisAttributes(green);

  name = "monitorChamber-enterWindow";

  G4Box* enterWindowSolid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fEnterWindowThickness / 2);
  G4LogicalVolume* enterWindowLog = new G4LogicalVolume(enterWindowSolid, WindowMaterial, name);
  enterWindowPhys =
    new G4PVPlacement(0, G4ThreeVector((-fBoxOuterThickness + fEnterWindowThickness) / 2, 0, 0),
                      name, enterWindowLog, chamberPhys, false, 0);
  enterWindowLog->SetVisAttributes(green);

  name = "monitorChamber-enterElectrode";
  G4double enterElectrodeThickness =
    fCopperLayerThickness + fKaptonLayerThickness + fNickelLayerThickness;
  G4double exitElectrodeThickness = enterElectrodeThickness;

  G4Box* enterElectrodeSolid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, enterElectrodeThickness / 2);
  G4LogicalVolume* enterElectrodeLog =
    new G4LogicalVolume(enterElectrodeSolid, CavityMaterial, name);

  enterElectrodePhys =
    new G4PVPlacement(0,
                      G4ThreeVector(-(fCentralWindowThickness + enterElectrodeThickness) / 2
                                      - (fCentralElectrodeThickness + fFirstCavityThickness),
                                    0, 0),
                      name, enterElectrodeLog, innerchamberPhys, false, 0);
  ...
  G4Box* kaptonLayerSolid1 =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fKaptonLayerThickness / 2);
  G4LogicalVolume* kaptonLayerLog1 =
    new G4LogicalVolume(kaptonLayerSolid1, KaptonLayerMaterial, name);
  kaptonLayerPhys1 = new G4PVPlacement(0, G4ThreeVector(position_kaptonLayer1, 0, 0), name,
                                       kaptonLayerLog1, enterElectrodePhys, false, 0);
  kaptonLayerLog1->SetVisAttributes(green);

  name = "monitorChamber-copperLayer1";

  G4double position_copperLayer1 =
    position_kaptonLayer1 + (fKaptonLayerThickness + fCopperLayerThickness) / 2;
  G4Box* copperLayerSolid1 =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fCopperLayerThickness / 2);
  G4LogicalVolume* copperLayerLog1 =
    new G4LogicalVolume(copperLayerSolid1, CopperLayerMaterial, name);
  copperLayerPhys1 = new G4PVPlacement(0, G4ThreeVector(position_copperLayer1, 0, 0), name,
                                       copperLayerLog1, enterElectrodePhys, false, 0);

  name = "monitorChamber-nickelLayer1";

  G4double position_nichelLayer1 =
    position_copperLayer1 + (fCopperLayerThickness + fNickelLayerThickness) / 2;

  G4Box* nickelLayerSolid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fNickelLayerThickness / 2);
  G4LogicalVolume* nickelLayerLog1 =
    new G4LogicalVolume(nickelLayerSolid, NichelLayerMaterial, name);
  nickelLayerPhys1 = new G4PVPlacement(0, G4ThreeVector(position_nichelLayer1, 0, 0), name,
                                       nickelLayerLog1, enterElectrodePhys, false, 0);

  name = "monitorChamber-firstCavity";

  G4double position_firstCavity =
    -fCentralWindowThickness / 2 - fCentralElectrodeThickness - (fFirstCavityThickness) / 2;
  G4Box* firstCavitySolid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fFirstCavityThickness / 2);
  G4LogicalVolume* fFirstCavityLog = new G4LogicalVolume(firstCavitySolid, CavityMaterial, name);
  fFirstCavityPhys = new G4PVPlacement(0, G4ThreeVector(position_firstCavity, 0, 0), name,
                                       fFirstCavityLog, innerchamberPhys, false, 0);
  ...
  G4Box* centralElectrode1Solid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fCentralElectrodeThickness / 2);
  G4LogicalVolume* centralElectrode1Log =
    new G4LogicalVolume(centralElectrode1Solid, ElectrodeMaterial, name);
  centralElectrode1Phys = new G4PVPlacement(0, G4ThreeVector(position_centralElectrode1, 0, 0),
                                            name, centralElectrode1Log, innerchamberPhys, false, 0);

  name = "monitorChamber-centralWindow";
  //  position={0,0,0};
  G4Box* centralWindowSolid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fCentralWindowThickness / 2);
  G4LogicalVolume* centralWindowLog =
    new G4LogicalVolume(centralWindowSolid, CentralWindowMaterial, name);
  centralWindowPhys = new G4PVPlacement(0, G4ThreeVector(0, 0, 0), name, centralWindowLog,
                                        innerchamberPhys, false, 0);
  ...
  G4Box* centralElectrode2Solid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fCentralElectrodeThickness / 2);
  G4LogicalVolume* centralElectrode2Log =
    new G4LogicalVolume(centralElectrode2Solid, ElectrodeMaterial, name);
  centralElectrode2Phys = new G4PVPlacement(0, G4ThreeVector(position_centralElectrode2, 0, 0),
                                            name, centralElectrode2Log, innerchamberPhys, false, 0);

  name = "monitorChamber-secondCavity";

  G4double position_secondCavity =
    (fCentralWindowThickness) / 2 + fCentralElectrodeThickness + (fSecondCavityThickness) / 2;
  G4Box* secondCavitySolid =
  ...
  fSecondCavityPhys = new G4PVPlacement(0, G4ThreeVector(position_secondCavity, 0, 0), name,
                                        fSecondCavityLog, innerchamberPhys, false, 0);

  name = "monitorChamber-exitElectrode";

  G4double position_exitElectrode = (fCentralWindowThickness) / 2 + fCentralElectrodeThickness
                                    + fSecondCavityThickness + (exitElectrodeThickness) / 2;
  G4Box* exitElectrodeSolid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, exitElectrodeThickness / 2);
  G4LogicalVolume* exitElectrodeLog =
    new G4LogicalVolume(exitElectrodeSolid, ElectrodeMaterial, name);
  exitElectrodePhys = new G4PVPlacement(0, G4ThreeVector(position_exitElectrode, 0, 0), name,
                                        exitElectrodeLog, innerchamberPhys, false, 0);
  ...
  G4Box* kaptonLayerSolid2 =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fKaptonLayerThickness / 2);
  G4LogicalVolume* kaptonLayerLog2 =
    new G4LogicalVolume(kaptonLayerSolid2, KaptonLayerMaterial, name);
  kaptonLayerPhys2 = new G4PVPlacement(0, G4ThreeVector(position_kaptonLayer2, 0, 0), name,
                                       kaptonLayerLog2, exitElectrodePhys, false, 0);

  name = "monitorChamber-copperLayer2";

  G4double position_copperLayer2 =
    (exitElectrodeThickness) / 2 - fKaptonLayerThickness - (fCopperLayerThickness) / 2;
  G4Box* copperLayerSolid2 =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fCopperLayerThickness / 2);
  G4LogicalVolume* copperLayerLog2 =
    new G4LogicalVolume(copperLayerSolid2, CopperLayerMaterial, name);
  copperLayerPhys2 = new G4PVPlacement(0, G4ThreeVector(position_copperLayer2, 0, 0), name,
                                       copperLayerLog2, exitElectrodePhys, false, 0);

  name = "monitorChamber-nickelLayer2";

  G4double position_nichelLayer2 = (exitElectrodeThickness) / 2 - fKaptonLayerThickness
                                   - fCopperLayerThickness - fNickelLayerThickness / 2;

  G4Box* nickelLayerSolid2 =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fNickelLayerThickness / 2);
  G4LogicalVolume* nickelLayerLog2 =
    new G4LogicalVolume(nickelLayerSolid2, NichelLayerMaterial, name);
  nickelLayerPhys2 = new G4PVPlacement(0, G4ThreeVector(position_nichelLayer2, 0, 0), name,
                                       nickelLayerLog2, exitElectrodePhys, false, 0);

  name = "monitorChamber-exitWindow";

  G4double position_exitWindow = (fBoxOuterThickness - fEnterWindowThickness) / 2;
  G4Box* exitWindowSolid =
    new G4Box(name, fInnerWidth / 2, fInnerHeight / 2, fExitWindowThickness / 2);
  G4LogicalVolume* exitWindowLog = new G4LogicalVolume(exitWindowSolid, WindowMaterial, name);
  exitWindowPhys = new G4PVPlacement(0, G4ThreeVector(position_exitWindow, 0, 0), name,
                                     exitWindowLog, chamberPhys, false, 0);
...
void BESTPassiveProtonBeamLine::BESTBeamNozzle()
{
  ...
  G4Box* solidNozzleSupport =
    new G4Box("NozzleSupport", nozzleSupportXSize, nozzleSupportYSize, nozzleSupportZSize);

  G4LogicalVolume* logicNozzleSupport =
    new G4LogicalVolume(solidNozzleSupport, nozzleSupportMaterial, "NozzleSupport");

  physiNozzleSupport =
    new G4PVPlacement(0, G4ThreeVector(nozzleSupportXPosition, 0., 0.), "NozzleSupport",
                      logicNozzleSupport, physicalTreatmentRoom, false, 0);
  ...
  G4Tubs* solidHoleNozzleSupport =
    new G4Tubs("HoleNozzleSupport", innerRadiusHoleNozzleSupport, outerRadiusHoleNozzleSupport,
               hightHoleNozzleSupport, startAngleHoleNozzleSupport, spanningAngleHoleNozzleSupport);

  G4LogicalVolume* logicHoleNozzleSupport = new G4LogicalVolume(
    solidHoleNozzleSupport, holeNozzleSupportMaterial, "HoleNozzleSupport", 0, 0, 0);
  ...
  G4Tubs* solidBrassTube = new G4Tubs("BrassTube", innerRadiusBrassTube, outerRadiusBrassTube,
                                      hightBrassTube, startAngleBrassTube, spanningAngleBrassTube);

  G4LogicalVolume* logicBrassTube =
    new G4LogicalVolume(solidBrassTube, brassTubeMaterial, "BrassTube", 0, 0, 0);

  physiBrassTube = new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(brassTubeXPosition, 0., 0.)),
                                     "BrassTube", logicBrassTube, physicalTreatmentRoom, false, 0);
  ...
  G4Tubs* solidBrassTube2 =
    new G4Tubs("BrassTube2", innerRadiusBrassTube2, outerRadiusBrassTube2, hightBrassTube2,
               startAngleBrassTube2, spanningAngleBrassTube2);

  G4LogicalVolume* logicBrassTube2 =
    new G4LogicalVolume(solidBrassTube2, brassTube2Material, "BrassTube2", 0, 0, 0);
  ...
  G4Tubs* solidBrassTube3 =
    new G4Tubs("BrassTube3", innerRadiusBrassTube3, outerRadiusBrassTube3, hightBrassTube3,
               startAngleBrassTube3, spanningAngleBrassTube3);

  G4LogicalVolume* logicBrassTube3 =
    new G4LogicalVolume(solidBrassTube3, brassTube3Material, "BrassTube3", 0, 0, 0);

  physiBrassTube3 =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(brassTube3XPosition, 0., 0.)), "BrassTube3",
                      logicBrassTube3, physicalTreatmentRoom, false, 0);
...
void BESTPassiveProtonBeamLine::BESTBeamFinalCollimator()
{
  ...
  solidFinalCollimator =
    new G4Tubs("FinalCollimator", BESTinnerRadiusFinalCollimator, outerRadiusFinalCollimator,
...
void BESTPassiveProtonBeamLine::SetFirstScatteringFoilXSize(G4double value)
{
  ...
  G4cout << "The X size of the first scattering foil is (mm):"
         << ((BESTfirstScatteringFoil->GetXHalfLength()) * 2.) / mm << G4endl;
}
...
void BESTPassiveProtonBeamLine::SetSecondScatteringFoilXSize(G4double value)
{
  ...
  G4cout << "The X size of the second scattering foil is (mm):"
         << ((BESTsecondScatteringFoil->GetXHalfLength()) * 2.) / mm << G4endl;
}
...
void BESTPassiveProtonBeamLine::SetOuterRadiusStopper(G4double value)
{
  ...
  G4RunManager::GetRunManager()->GeometryHasBeenModified();
  G4cout << "OuterRadius od the Stopper is (mm):" << solidBESTStopper->GetOuterRadius() / mm
         << G4endl;
}
...
void BESTPassiveProtonBeamLine::SetRSMaterial(G4String materialChoice)
{
        ...
        G4NistManager::Instance()->FindOrBuildMaterial(materialChoice, false))
  {
    if (pttoMaterial)
    {
      ...
      G4cout << "The material of the Range Shifter has been changed to " << materialChoice
             << G4endl;
    }
  }
  else

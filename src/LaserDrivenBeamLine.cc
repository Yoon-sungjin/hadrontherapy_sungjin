...
LaserDrivenBeamLine::LaserDrivenBeamLine()
  : hadrontherapydetectorconstruction(0),
    ...
    physicThirdQuad(0),
    physicFourthQuad(0),
    solidExternalChamber(0),
    logicExternalChamber(0),
    physicExternalChamber(0),
    solidInternalChamber(0),
    logicInternalChamber(0),
    physicInternalChamber(0),
    solidCollimator(0),
    logicCollimator(0),
    physicCollimator(0),
    solidCollimatorHole(0),
    logicCollimatorHole(0),
    physicCollimatorHole(0),
    solidFinalCollimator(0),
    logicFinalCollimator(0),
    physicFinalCollimator(0),
    solidFinalCollimatorHole(0),
    logicFinalCollimatorHole(0),
    physicFinalCollimatorHole(0),
    solidExternalMagnet_1(0),
    logicExternalMagnet_1(0),
    physicExternalMagnet_1(0),
    physicExternalMagnet_1Down(0),
    solidMagnet_1(0),
    logicMagnet_1(0),
    physicMagnet_1Right(0),
    physicMagnet_1Left(0),
    solidExternalMagnet_2(0),
    logicExternalMagnet_2(0),
    physicExternalMagnet_2(0),
    physicExternalMagnet_2Down(0),
    solidMagnet_2(0),
    logicMagnet_2(0),
    physicMagnet_2Right(0),
    physicMagnet_2Left(0),
    solidExternalMagnet_3(0),
    logicExternalMagnet_3(0),
    physicExternalMagnet_3(0),
    physicExternalMagnet_3Down(0),
    solidMagnet_3(0),
    logicMagnet_3(0),
    physicMagnet_3Right(0),
    physicMagnet_3Left(0),
    solidExternalMagnet_4(0),
    logicExternalMagnet_4(0),
    physicExternalMagnet_4(0),
    physicExternalMagnet_4Down(0),
    solidMagnet_4(0),
    logicMagnet_4(0),
    physicMagnet_4Right(0),
    physicMagnet_4Left(0),
    solidExternalSlit(0),
    logicExternalSlit(0),
    physicExternalSlit(0),
    solidInternalSlit(0),
    logicInternalSlit(0),
    physicInternalSlit(0),
    physicExitPipe(0),
    physicExitWindow(0),
    physicExithole(0),
    physicEntrancePipe(0),
    physicEntrancehole(0)
{
...
void LaserDrivenBeamLine::SetDefaultDimensions()
{
  ...
  G4double defaultExternalChamberXPosition =
    -(externalChamberXSize / 2. + ExitPipeheight / 2.) + ExitPipeXPosition;
  ...
  defaultFinalCollimatorXPosition =
    internalChamberXSize / 2. - ExitholeToFinalCollimator - FinalCollimatorThickness / 2.;
  ...
  G4double defaultExternalMagnet_YSize =
    (defaultExternalMagnet_YSizeTotal - defaultInternalMagnet_YSize) / 2.;
  G4double defaultExternalMagnet_ZSize = 104 * mm;

  G4double defaultExternalMagnet_YPosition =
    defaultInternalMagnet_YSize / 2. + defaultExternalMagnet_YSize / 2.;
  ...
  G4double defaultExternalMagnet_4XPosition =
    -(FinalCollimatorThickness / 2. + FinalCollimatorToMagnet4 + defaultExternalMagnet_XSize / 2.)
  ...
  G4double defaultExternalMagnet_3XPosition =
    -(Magnet4ToMagnet3 + defaultExternalMagnet_XSize / 2. + defaultExternalMagnet_XSize / 2.)
  ...
  G4double defaultExternalMagnet_2XPosition =
    -(Magnet3ToMagnet2 + defaultExternalMagnet_XSize / 2. + defaultExternalMagnet_XSize / 2.)
  ...
  G4double defaultExternalMagnet_1XPosition =
    -(Magnet2ToMagnet1 + defaultExternalMagnet_XSize / 2. + defaultExternalMagnet_XSize / 2.)
  ...
  G4double defaultExternalSlitXPosition =
    -(Magnet3ToMagnet2 / 2. + defaultExternalMagnet_XSize / 2.) + externalMagnet_3XPosition;
  ...
  defaultCollimatorXPosition =
    -(thicknessCollimator / 2. + Magnet1ToFirstCollimator + defaultExternalMagnet_XSize / 2.)
  ...
  G4double defaultEntranceholeQuadXPosition =
    +(externalChamberXSize / 2. - EntranceholeThickness / 2.);
  ...
  G4double defaultEntrancePipeXPosition =
    -EntrancePipeheight / 2 - externalChamberXSize / 2 + externalChamberXPosition;
  ...
  /////////////////////////////////////Quadrupole//////////////////////////////////
  G4double defaultQuadChamberWallPosX =
    -(externalChamberXSize / 2.) - EntrancePipeheight / 2. + EntrancePipeXPosition;
  ...
  G4double defaultFourthQuadXPosition =
    internalChamberXSize / 2. - distancefromQuadChamber - FourthQuadThickness / 2.;
  FourthQuadXPosition = defaultFourthQuadXPosition;
  FourthQXPosition = 0.0 * mm;

  G4double distanceFQuadTQuad = 100.0 * mm;
  G4double defaultThirdQuadXPosition =
    -ThirdQuadThickness / 2. - distanceFQuadTQuad - FourthQuadThickness / 2. + FourthQuadXPosition;
  ThirdQuadXPosition = defaultThirdQuadXPosition;
  ThirdQXPosition = 0.0 * mm;

  G4double distanceTQuadSQuad = 100.0 * mm;
  G4double defaultSecondQuadXPosition =
    -SecondQuadThickness / 2. - distanceTQuadSQuad - ThirdQuadThickness / 2. + ThirdQuadXPosition;
  SecondQuadXPosition = defaultSecondQuadXPosition;
  SecondQXPosition = 0.0 * mm;

  G4double distanceSQuadFQuad = 100.0 * mm;
  G4double defaultFirstQuadXPosition =
    -FirstQuadThickness / 2. - distanceSQuadFQuad - SecondQuadThickness / 2. + SecondQuadXPosition;
  ...
  G4Material* stainless_steelNist =
    G4NistManager::Instance()->FindOrBuildMaterial("G4_STAINLESS-STEEL", isotopes);
  ...
  G4Material* vacuum =
    new G4Material("interGalactic", atomicNumber, massOfMole, d, kStateGas, temperature, pressure);
...
void LaserDrivenBeamLine::ConstructLaserDrivenBeamLine()
{
  ...
  solidTreatmentRoom = new G4Box("TreatmentRoom", worldX, worldY, worldZ);

  logicTreatmentRoom =
    new G4LogicalVolume(solidTreatmentRoom, MotherMaterial, "logicTreatmentRoom", 0, 0, 0);
...
void LaserDrivenBeamLine::ConstructSDandField()
{
  ...
  if (LFourthTriplet)
  {
    ...
    PurgMagFieldQuadFourth =
      new HadrontherapyMagneticField3D("field/Quad80MagneticField.TABLE", xOffsetFQ);
    ...
    pIntgrDriverQuadFourth =
      new G4MagInt_Driver(1 * mm, fstepperQuadFourth, fstepperQuadFourth->GetNumberOfVariables());
    // the first parameter is the minimum step
  ...
  if (LThirdTriplet)
  {
    ...
    PurgMagFieldQuadThird =
      new HadrontherapyMagneticField3D("field/Quad40MagneticField.TABLE", xOffsetTQ);
    ...
    pIntgrDriverQuadThird =
      new G4MagInt_Driver(1 * mm, fstepperQuadThird, fstepperQuadThird->GetNumberOfVariables());
    // the first parameter is the minimum step
  ...
  if (LSecondTriplet)
  {
    ...
    PurgMagFieldQuadSecond =
      new HadrontherapyMagneticField3D("field/Quad40MagneticField.TABLE", xOffsetSQ);
    ...
    pIntgrDriverQuadSecond =
      new G4MagInt_Driver(1 * mm, fstepperQuadSecond, fstepperQuadSecond->GetNumberOfVariables());
    // the first parameter is the minimum step
  ...
  if (LFirstTriplet)
  {
    ...
    PurgMagFieldQuadFirst =
      new HadrontherapyMagneticField3D("field/Quad80MagneticField.TABLE", xOffsetFirstQ);
    ...
    pIntgrDriverQuadFirst =
      new G4MagInt_Driver(1 * mm, fstepperQuadFirst, fstepperQuadFirst->GetNumberOfVariables());
    // the first parameter is the minimum step
  ...
  if (logicVirtualMag)
  {
    ...
    G4ElectricField* ElectricField = new HadrontherapyElectricTabulatedField3D(
      "field/ElectricFieldFC-600V.TABLE", exOffset, eyOffset, ezOffset);
    // UNIFORM FIELD
    // G4ElectroMagneticField* ElectricField = new
    // G4UniformElectricField(G4ThreeVector(0.0, 10.0*volt/m, 0.0)); //G4UniformElectricField The
    // following is only for global field in the whole geometry
    // pEFieldmanager = G4TransportationManager::GetTransportationManager() -> GetFieldManager();

    const G4int nvarElectric =
      8;  // The Equation of motion for Electric (or combined Electric/Magnetic)
    ...
    G4MagInt_Driver* pIntgrDriver_E =
      new G4MagInt_Driver(0.02 * mm, fLocalStepper, fLocalStepper->GetNumberOfVariables());
  ...
  G4cout << " //....oooOO0OOooo.......... FIELDS HAVE BEEN IMPLEMENTED..........oooOO0OOooo...."
         << G4endl;
  return;
}
...
void LaserDrivenBeamLine::FaradayCup()
{
  ...
  G4double KaptonEntranceWindowPosX =
    -virtualMagPosX + KaptonEntranceWindowThickness / 2 + FC_XOffset;
  G4double MassRingPosX =
    KaptonEntranceWindowPosX + KaptonEntranceWindowThickness / 2 + MassRingThickness / 2;
  ...
  G4double FaradayCupBottomPosX =
    GuardRingPosX + GuardRingThickness / 2 + FaradayCupBottomThickness / 2 + 1 * cm;
  G4double VirtualBottomPosX =
    FaradayCupBottomPosX + FaradayCupBottomThickness / 2 + VirtualBottomThickness / 2;
  ...
  G4double VirtualLateralPosX =
    GuardRingPosX + GuardRingThickness / 2 + 1 * cm
    + (FaradayCupBottomThickness + CupThickness + VirtualBottomThickness) / 2;
  G4double phi = 90. * deg;
  G4RotationMatrix rm;
  rm.rotateY(phi);
  ...
  logicVirtualMag =
    new G4LogicalVolume(virtualMag, internalChamberMaterial, "LVirtualMag", 0, 0, 0);
  physicVirtualMag =
    new G4PVPlacement(0, G4ThreeVector(virtualMagPosX, 0. * cm, 0 * mm), "PVirtualMag",
                      logicVirtualMag, physicTreatmentRoom, true, 0);
  ...
  G4SubtractionSolid* BeveledCylinder =
    new G4SubtractionSolid("Cylinder-Box", Cylinder, Box, Rot, trans);

  logicBeveledCylinder =
    new G4LogicalVolume(BeveledCylinder, GuardRingMaterial, "LBeveledCylinder", 0, 0, 0);

  physicBeveledCylinder =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(GuardRingPosX, 0, 0)),
                      "physicBeveledCylinder", logicBeveledCylinder, physicVirtualMag, true, 0);

  logicBeveledCylinder->SetVisAttributes(green);

  ///// KaptonEntranceWindow /////

  KaptonEntranceWindow = new G4Tubs("KaptonEntranceWindow", 0, OuterRadiusFC,
                                    KaptonEntranceWindowThickness / 2, 0 * deg, 360 * deg);

  logicKaptonEntranceWindow =
    new G4LogicalVolume(KaptonEntranceWindow,
                        // internalChamberMaterial, for track control
                        KaptonEntranceWindowMaterial, "LKaptonEntranceWindow", 0, 0, 0);

  physicKaptonEntranceWindow =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(KaptonEntranceWindowPosX, 0, 0)),
                      "PhysicEntranceWindow", logicKaptonEntranceWindow, physicVirtualMag, true, 0);
  logicKaptonEntranceWindow->SetVisAttributes(gray);

  ////// MassRing /////

  MassRing =
    new G4Tubs("MassRing", InnerRadiusFC, OuterRadiusFC, MassRingThickness / 2, 0 * deg, 360 * deg);

  logicMassRing = new G4LogicalVolume(MassRing, MassRingMaterial, "logicMassRing", 0, 0, 0);
  ...
  VirtualWindow =
    new G4Tubs("VirtualWindow", 0, OuterRadiusFC, VirtualWindowThickness / 2, 0 * deg, 360 * deg);

  logicVirtualWindow =
    new G4LogicalVolume(VirtualWindow, internalChamberMaterial, "logicVirtualWindow", 0, 0, 0);

  physicVirtualWindow =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(VirtualWindowPosX, 0, 0)),

                      "PhysicVirtualWindow", logicVirtualWindow, physicVirtualMag, true, 0);
  logicVirtualWindow->SetVisAttributes(G4VisAttributes::GetInvisible());

  ///// GuardRing /////

  GuardRing = new G4Tubs("GuardRing", InnerRadiusFC, OuterRadiusFC, GuardRingThickness / 2, 0 * deg,
                         360 * deg);

  logicGuardRing = new G4LogicalVolume(GuardRing, GuardRingMaterial, "logicGuardRing", 0, 0, 0);
  ...
  VirtualMiddle =
    new G4Tubs("VirtualMiddle", 0, OuterRadiusFC, VirtualMiddleThickness / 2, 0 * deg, 360 * deg);

  logicVirtualMiddle =
    new G4LogicalVolume(VirtualMiddle, internalChamberMaterial, "logicVirtualMiddle", 0, 0, 0);
  ...
  FaradayCupBottom = new G4Tubs("FaradayCupBottom", InnerRadiusFC, OuterRadiusFC,
                                FaradayCupBottomThickness / 2, 0 * deg, 360 * deg);

  logicFaradayCupBottom = new G4LogicalVolume(FaradayCupBottom, FaradayCupBottomMaterial,
                                              "logicFaradayCupBottom", 0, 0, 0);

  physicFaradayCupBottom =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(FaradayCupBottomPosX, 0, 0)),
                      "PhysicFaradayCupBottom", logicFaradayCupBottom, physicVirtualMag, true, 0);
  logicFaradayCupBottom->SetVisAttributes(yellow);

  ///// Virtual Bottom //////

  VirtualBottom =
    new G4Tubs("VirtualBottom", 0, OuterRadiusFC, VirtualBottomThickness / 2, 0 * deg, 360 * deg);

  logicVirtualBottom =
    new G4LogicalVolume(VirtualBottom, internalChamberMaterial, "logicVirtualBottom", 0, 0, 0);

  physicVirtualBottom =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(VirtualBottomPosX, 0, 0)),
                      "PhysicVirtualBottom", logicVirtualBottom, physicVirtualMag, true, 0);

  logicVirtualBottom->SetVisAttributes(G4VisAttributes::GetInvisible());

  ///// Cup /////

  Cup = new G4Tubs("Cup", 0, OuterRadiusFC, CupThickness / 2, 0 * deg, 360 * deg);

  logicCup = new G4LogicalVolume(Cup, CupMaterial, "logicCup", 0, 0, 0);

  physicCup =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(CupPosX, 0, 0)), "PhysicCup", logicCup,
  ...
  VirtualOverBottom = new G4Tubs("VirtualOverBottom", 0, OuterRadiusFC,
                                 VirtualOverBottomThickness / 2, 0 * deg, 360 * deg);

  logicVirtualOverBottom = new G4LogicalVolume(VirtualOverBottom, internalChamberMaterial,
                                               "logicVirtualOverBottom", 0, 0, 0);

  physicVirtualOverBottom =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(VirtualOverBottomPosX, 0, 0)),
  ...
  VirtualLateral = new G4Tubs("VirtualLateral", OuterRadiusFC,
                              OuterRadiusFC + 1 * um,  // the VirtualLateralThickness is 1*um
                              VirtualLateralLength / 2, 0 * deg, 360 * deg);

  logicVirtualLateral =
    new G4LogicalVolume(VirtualLateral, internalChamberMaterial, "logicVirtualLateral", 0, 0, 0);

  physicVirtualLateral =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(VirtualLateralPosX, 0, 0)), "VirtualLateral",
                      logicVirtualLateral,
...
void LaserDrivenBeamLine::Quadrupole()
{
  ...
  SQuadChamberWall = new G4Box("solidQuadChamberWall", externalChamberXSize / 2.,
                               externalChamberYSize / 2., externalChamberZSize / 2.);

  LQuadChamberWall =
    new G4LogicalVolume(SQuadChamberWall, externalChamberMaterial, "logicQuadChamberWall");

  PQuadChamberWall = new G4PVPlacement(
    0, G4ThreeVector(QuadChamberWallPosX, QuadChamberWallPosY, QuadChamberWallPosZ),
    "physQuadChamberWall", LQuadChamberWall, physicTreatmentRoom, false, 0);

  SQuadChamber = new G4Box("solidQuadChamber", internalChamberXSize / 2., internalChamberYSize / 2.,
                           internalChamberZSize / 2.);

  LQuadChamber = new G4LogicalVolume(SQuadChamber, internalChamberMaterial, "logicQuadChamber");

  PQuadChamber = new G4PVPlacement(0, G4ThreeVector(0.0, 0.0, 0.0), "physQuadChamber", LQuadChamber,
                                   PQuadChamberWall, false, 0);

  LQuadChamberWall->SetVisAttributes(red);
  LQuadChamber->SetVisAttributes(white);
  ///////////----------------------------Fourth Quadrupole----------------------------/////////
  SFourthTriplet =
    new G4Tubs("SolidTQuad", InnerRadiusTriplet, ExternalRadiusQuad,
               ((FourthQuadThickness / 2.) + 1 * mm), startAngleQuad, spanningAngleQuad);

  LFourthTriplet =
    new G4LogicalVolume(SFourthTriplet, internalChamberMaterial, "LogicTQuad", 0, 0, 0);

  PFourthTriplet = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(FourthQuadXPosition, QuadYPosition, QuadZPosition)),
    "PhysFourthTQuad", LFourthTriplet, PQuadChamber, false, 0);

  solidFourthQuad = new G4Tubs("SolidQuad", InnerRadiusQuad, ExternalRadiusQuad,
                               FourthQuadThickness / 2., startAngleQuad, spanningAngleQuad);
  ...
  ///////////----------------------------Third Quadrupole----------------------------/////////
  SThirdTriplet = new G4Tubs("SolidTTQuad", InnerRadiusTriplet, ExternalRadiusQuad,
                             (ThirdQuadThickness / 2.) + 1 * mm, startAngleQuad, spanningAngleQuad);

  LThirdTriplet =
    new G4LogicalVolume(SThirdTriplet, internalChamberMaterial, "LogicTTQuad", 0, 0, 0);

  PThirdTriplet = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(ThirdQuadXPosition, QuadYPosition, QuadZPosition)),
    "PhysThirdTQuad", LThirdTriplet, PQuadChamber, false, 0);

  solidThirdQuad = new G4Tubs("SolidTQuad", InnerRadiusQuad, ExternalRadiusQuad,
                              ThirdQuadThickness / 2., startAngleQuad, spanningAngleQuad);
  ...
  ///////////----------------------------Second Quadrupole----------------------------/////////
  SSecondTriplet =
    new G4Tubs("SolidTSQuad", InnerRadiusTriplet, ExternalRadiusQuad,
               (SecondQuadThickness / 2.) + 1 * mm, startAngleQuad, spanningAngleQuad);

  LSecondTriplet =
    new G4LogicalVolume(SSecondTriplet, internalChamberMaterial, "LogicTSQuad", 0, 0, 0);

  PSecondTriplet = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(SecondQuadXPosition, QuadYPosition, QuadZPosition)),
    "PhysSecondTQuad", LSecondTriplet, PQuadChamber, false, 0);

  solidSecondQuad = new G4Tubs("SolidSQuad", InnerRadiusQuad, ExternalRadiusQuad,
                               SecondQuadThickness / 2., startAngleQuad, spanningAngleQuad);
  ...
  ///////////----------------------------First Quadrupole----------------------------/////////
  SFirstTriplet = new G4Tubs("SolidTQuad", InnerRadiusTriplet, ExternalRadiusQuad,
                             (FirstQuadThickness / 2.) + 1 * mm, startAngleQuad, spanningAngleQuad);

  LFirstTriplet =
    new G4LogicalVolume(SFirstTriplet, internalChamberMaterial, "LogicTQuad", 0, 0, 0);

  PFirstTriplet = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(FirstQuadXPosition, QuadYPosition, QuadZPosition)),
    "PhysFirstTQuad", LFirstTriplet, PQuadChamber, false, 0);

  solidFirstQuad = new G4Tubs("SolidQuad", InnerRadiusQuad, ExternalRadiusQuad,
                              FirstQuadThickness / 2., startAngleQuad, spanningAngleQuad);
...
void LaserDrivenBeamLine::EnergySelectorChamber()
{
  ...
  solidExternalChamber = new G4Box("ExternalChamber", externalChamberXSize / 2.0,
                                   externalChamberYSize / 2.0, externalChamberZSize / 2.0);

  logicExternalChamber =
    new G4LogicalVolume(solidExternalChamber, externalChamberMaterial, "ExternalChamber");

  physicExternalChamber = new G4PVPlacement(
    0, G4ThreeVector(externalChamberXPosition, externalChamberYPosition, externalChamberZPosition),
    "ExternalChamber", logicExternalChamber, physicTreatmentRoom, false, 0);

  // Visualisation of the External part
  logicExternalChamber->SetVisAttributes(red);

  // This is a vacuum box inside the steel box
  solidInternalChamber = new G4Box("SInternalChamber", internalChamberXSize / 2.0,
                                   internalChamberYSize / 2.0, internalChamberZSize / 2.0);

  logicInternalChamber =
    new G4LogicalVolume(solidInternalChamber, internalChamberMaterial, "LInternalChamber");

  physicInternalChamber = new G4PVPlacement(0, G4ThreeVector(0, 0, 0), "InternalChamber",
                                            logicInternalChamber, physicExternalChamber, false, 0);
...
void LaserDrivenBeamLine::EntrancePipe()
{
  ...
  solidEntrancePipe =
    new G4Tubs("EntrancePipe", InnerRadiusEntrancePipe, ExternalRadiusEntrancePipe,
               EntrancePipeheight / 2., startAngleEntrancePipe, spanningAngleEntrancePipe);

  logicEntrancePipe = new G4LogicalVolume(solidEntrancePipe, PipeMaterial, "EntrancePipe", 0, 0, 0);

  physicEntrancePipe =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(EntrancePipeXPosition, EntrancePipeYPosition,
                                                      EntrancePipeZPosition)),
                      "EntrancePipe", logicEntrancePipe, physicTreatmentRoom, false, 0);
...
void LaserDrivenBeamLine::Entrancehole()
{
  ...
  solidEntrancehole =
    new G4Tubs("Entrancehole", InnerRadiusEntrancehole, ExternalRadiusEntrancehole,
               EntranceholeThickness / 2., startAngleEntrancehole, spanningAngleEntrancehole);

  logicEntrancehole =
    new G4LogicalVolume(solidEntrancehole, internalChamberMaterial, "Entrancehole", 0, 0, 0);
  // the hole in the energy selector chamber
  physicEntranceholeESSChamber =
    new G4PVPlacement(G4Transform3D(rm, G4ThreeVector(EntranceholeXPosition, EntranceholeYPosition,
                                                      EntranceholeZPosition)),
                      "Entrancehole", logicEntrancehole, physicExternalChamber, false, 0);
  // the hole in the quadrupoles chamber
  physicEntrancehole = new G4PVPlacement(
    G4Transform3D(
      rm, G4ThreeVector(EntranceholeQuadXPosition, EntranceholeYPosition, EntranceholeZPosition)),
    "EntranceholeQuad", logicEntrancehole, PQuadChamberWall, false, 0);
...
void LaserDrivenBeamLine::Collimator()
{
  ...
  solidCollimator = new G4Box("collimator", thicknessCollimator / 2.0, collimatorBoxYSize / 2.0,
                              collimatorBoxZSize / 2.0);

  logicCollimator = new G4LogicalVolume(solidCollimator, collimatorMaterial, "collimator");

  physicCollimator = new G4PVPlacement(
    0, G4ThreeVector(collimatorBox_XPosition, collimatorBox_YPosition, collimatorBox_ZPosition),
    "collimator", logicCollimator, physicInternalChamber, false, 0);

  logicCollimator->SetVisAttributes(darkOrange3);

  solidCollimatorHole =
    new G4Tubs("CollimatorHole", innerRadiusCollimator, outerRadiusCollimator,
               thicknessCollimator / 2., startAngleCollimator, spanningAngleCollimator);

  logicCollimatorHole =
    new G4LogicalVolume(solidCollimatorHole, collimatorHoleMaterial, "CollimatorHole", 0, 0, 0);

  physicCollimatorHole = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(collimatorXPosition, collimatorYPosition, collimatorZPosition)),
    "CollimatorHole", logicCollimatorHole, physicCollimator, false, 0);
...
{  // The positions of the external and internal partes are given as respect the external chamber.
  solidExternalMagnet_1 = new G4Box("SolidExternalMagnet_1", externalMagnet_1XSize / 2.0,
                                    externalMagnet_1YSize / 2.0, externalMagnet_1ZSize / 2.0);

  logicExternalMagnet_1 =
    new G4LogicalVolume(solidExternalMagnet_1, externalMagnet_1Material, "LogicExternalMagnet_1");

  physicExternalMagnet_1 = new G4PVPlacement(
    0,
    G4ThreeVector(externalMagnet_1XPosition, externalMagnet_2YPosition, externalMagnet_2ZPosition),
    "PhysicExternalMagnet_1", logicExternalMagnet_1, physicInternalChamber, false, 0);
  physicExternalMagnet_1Down = new G4PVPlacement(
    0,
    G4ThreeVector(externalMagnet_1XPosition, -externalMagnet_2YPosition, externalMagnet_2ZPosition),
    "PhysicExternalMagnet_1Down", logicExternalMagnet_1, physicInternalChamber, false, 0);

  logicExternalMagnet_1->SetVisAttributes(gray);

  // The right and left part of the magnet
  solidMagnet_1 =
    new G4Box("SolidMagnet_1", Magnet_1XSize / 2.0, Magnet_1YSize / 2.0, Magnet_1ZSize / 2.0);

  logicMagnet_1 = new G4LogicalVolume(solidMagnet_1, externalMagnet_1Material, "LogicMagnet_1");

  physicMagnet_1Right =
    new G4PVPlacement(0, G4ThreeVector(Magnet_1XPosition, Magnet_1YPosition, Magnet_1ZPosition),
                      "PhysicMagnet_1Right", logicMagnet_1, physicInternalChamber, false, 0);
  physicMagnet_1Left =
    new G4PVPlacement(0, G4ThreeVector(Magnet_1XPosition, Magnet_1YPosition, -Magnet_1ZPosition),
                      "PhysicMagnet_1Left", logicMagnet_1, physicInternalChamber, false, 0);
...
{  // The position of the external part are given as respect the external chamber.
  ...
  solidExternalMagnet_2 = new G4Box("SolidExternalMagnet_2", externalMagnet_2XSize / 2.0,
                                    externalMagnet_2YSize / 2.0, externalMagnet_2ZSize / 2.0);

  logicExternalMagnet_2 =
    new G4LogicalVolume(solidExternalMagnet_2, externalMagnet_2Material, "LogicExternalMagnet_2");

  physicExternalMagnet_2 = new G4PVPlacement(
    0,
    G4ThreeVector(externalMagnet_2XPosition, externalMagnet_2YPosition,
                  (externalMagnet_2ZPosition + 32 * mm)),
    "PhysicExternalMagnet_2", logicExternalMagnet_2, physicInternalChamber, false, 0);

  physicExternalMagnet_2Down = new G4PVPlacement(
    0,
    G4ThreeVector(externalMagnet_2XPosition, -externalMagnet_2YPosition,
                  (externalMagnet_2ZPosition + 32 * mm)),
    "PhysicExternalMagnet_2Down", logicExternalMagnet_2, physicInternalChamber, false, 0);

  logicExternalMagnet_2->SetVisAttributes(gray);

  // The right and left part of the magnet
  solidMagnet_2 =
    new G4Box("SolidMagnet_2", Magnet_2XSize / 2.0, Magnet_2YSize / 2.0, Magnet_2ZSize / 2.0);

  logicMagnet_2 = new G4LogicalVolume(solidMagnet_2, externalMagnet_2Material, "LogicMagnet_2");

  physicMagnet_2Right = new G4PVPlacement(
    0, G4ThreeVector(Magnet_2XPosition, Magnet_2YPosition, (Magnet_2ZPosition) + 32 * mm),
    "PhysicMagnet_2Right", logicMagnet_2, physicInternalChamber, false, 0);
  physicMagnet_2Left = new G4PVPlacement(
    0, G4ThreeVector(Magnet_2XPosition, Magnet_2YPosition, (-(Magnet_2ZPosition) + 32 * mm)),
    "PhysicMagnet_2Left", logicMagnet_2, physicInternalChamber, false, 0);
...
{  // The position of the external part are given as respect the external chamber.
  ...
  solidExternalMagnet_3 = new G4Box("SolidExternalMagnet_3", externalMagnet_3XSize / 2.0,
                                    externalMagnet_3YSize / 2.0, externalMagnet_3ZSize / 2.0);

  logicExternalMagnet_3 =
    new G4LogicalVolume(solidExternalMagnet_3, externalMagnet_3Material, "LogicExternalMagnet_3");

  physicExternalMagnet_3 = new G4PVPlacement(
    0,
    G4ThreeVector((externalMagnet_3XPosition), externalMagnet_3YPosition,
                  (externalMagnet_3ZPosition + 32 * mm)),
    "PhysicExternalMagnet_3", logicExternalMagnet_3, physicInternalChamber, false, 0);

  physicExternalMagnet_3Down = new G4PVPlacement(
    0,
    G4ThreeVector((externalMagnet_3XPosition), -externalMagnet_3YPosition,
                  (externalMagnet_3ZPosition + 32 * mm)),
    "PhysicExternalMagnet_3Down", logicExternalMagnet_3, physicInternalChamber, false, 0);

  logicExternalMagnet_3->SetVisAttributes(gray);

  // The right and left part of the magnet
  solidMagnet_3 =
    new G4Box("SolidMagnet_3", Magnet_3XSize / 2.0, Magnet_3YSize / 2.0, Magnet_3ZSize / 2.0);

  logicMagnet_3 = new G4LogicalVolume(solidMagnet_3, externalMagnet_3Material, "LogicMagnet_3");

  physicMagnet_3Right = new G4PVPlacement(
    0, G4ThreeVector(Magnet_3XPosition, Magnet_3YPosition, (Magnet_3ZPosition + 32 * mm)),
    "PhysicMagnet_3Right", logicMagnet_3, physicInternalChamber, false, 0);
  physicMagnet_3Left = new G4PVPlacement(
    0, G4ThreeVector(Magnet_3XPosition, Magnet_3YPosition, (-(Magnet_3ZPosition) + 32 * mm)),
    "PhysicMagnet_3Left", logicMagnet_3, physicInternalChamber, false, 0);
...
{  // The position of the external part are given as respect the external chamber.
  ...
  solidExternalMagnet_4 = new G4Box("SolidExternalMagnet_4", externalMagnet_4XSize / 2.0,
                                    externalMagnet_4YSize / 2.0, externalMagnet_4ZSize / 2.0);

  logicExternalMagnet_4 =
    new G4LogicalVolume(solidExternalMagnet_4, externalMagnet_4Material, "LogicExternalMagnet_4");

  physicExternalMagnet_4 = new G4PVPlacement(
    0,
    G4ThreeVector(externalMagnet_4XPosition, externalMagnet_4YPosition, externalMagnet_4ZPosition),
    "PhysicExternalMagnet_4", logicExternalMagnet_4, physicInternalChamber, false, 0);

  physicExternalMagnet_4Down = new G4PVPlacement(
    0,
    G4ThreeVector(externalMagnet_4XPosition, -externalMagnet_4YPosition, externalMagnet_4ZPosition),
    "PhysicExternalMagnet_4Down", logicExternalMagnet_4, physicInternalChamber, false, 0);

  logicExternalMagnet_4->SetVisAttributes(gray);

  // The right and left part of the magnet
  solidMagnet_4 =
    new G4Box("SolidMagnet_4", Magnet_4XSize / 2.0, Magnet_4YSize / 2.0, Magnet_4ZSize / 2.0);

  logicMagnet_4 = new G4LogicalVolume(solidMagnet_4, externalMagnet_4Material, "LogicMagnet_4");

  physicMagnet_4Right =
    new G4PVPlacement(0, G4ThreeVector(Magnet_4XPosition, Magnet_4YPosition, Magnet_4ZPosition),
                      "PhysicMagnet_4Right", logicMagnet_4, physicInternalChamber, false, 0);
  physicMagnet_4Left =
    new G4PVPlacement(0, G4ThreeVector(Magnet_4XPosition, Magnet_4YPosition, -Magnet_4ZPosition),
                      "PhysicMagnet_4Left", logicMagnet_4, physicInternalChamber, false, 0);
...
{
  solidExternalSlit = new G4Box("ExternalSlit", externalSlitXSize / 2.0, externalSlitYSize / 2.0,
                                externalSlitZSize / 2.0);

  logicExternalSlit = new G4LogicalVolume(solidExternalSlit, externalSlitMaterial, "ExternalSlit");

  physicExternalSlit = new G4PVPlacement(
    0, G4ThreeVector(externalSlitXPosition, externalSlitYPosition, externalSlitZPosition),
    "ExternalSlit", logicExternalSlit, physicInternalChamber, false, 0);

  logicExternalSlit->SetVisAttributes(green);
  // The hole
  solidInternalSlit = new G4Box("InternalSlit", internalSlitXSize / 2.0, internalSlitYSize / 2.0,
                                internalSlitZSize / 2.0);

  logicInternalSlit = new G4LogicalVolume(solidInternalSlit, internalSlitMaterial, "InternalSlit");

  physicInternalSlit = new G4PVPlacement(
    0, G4ThreeVector(internalSlitXPosition, internalSlitYPosition, internalSlitZPosition),
    "InternalSlit", logicInternalSlit, physicExternalSlit, false, 0);
...
void LaserDrivenBeamLine::FinalCollimator()
{
  ...
  solidFinalCollimator = new G4Box("collimatorFinal", collimatorFinalBoxXSize / 2.0,
                                   collimatorFinalBoxYSize / 2.0, collimatorFinalBoxZSize / 2.0);

  logicFinalCollimator =
    new G4LogicalVolume(solidFinalCollimator, FinalcollimatorMaterial, "collimatorFinal");

  physicFinalCollimator =
    new G4PVPlacement(0,
                      G4ThreeVector(collimatorFinalBox_XPosition, collimatorFinalBox_YPosition,
                                    collimatorFinalBox_ZPosition),
                      "collimatorFinal", logicFinalCollimator, physicInternalChamber, false, 0);
  logicFinalCollimator->SetVisAttributes(darkOrange3);

  solidFinalCollimatorHole = new G4Tubs("FinalCollimatorHole", innerRadiusFinalCollimator,
                                        outerRadiusFinalCollimator, FinalCollimatorThickness / 2.,
                                        startAngleFinalCollimator, spanningAngleFinalCollimator);

  logicFinalCollimatorHole = new G4LogicalVolume(
    solidFinalCollimatorHole, FinalcollimatorHoleMaterial, "FinalCollimatorHole", 0, 0, 0);

  physicFinalCollimatorHole = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(FinalcollimatorXPosition, FinalcollimatorYPosition,
                                    FinalcollimatorZPosition)),
    "FinalCollimatorHole", logicFinalCollimatorHole, physicFinalCollimator, false, 0);
...
void LaserDrivenBeamLine::ExitWindow()
{
  ...
  solidExitWindow =
    new G4Tubs("ExitWindow", InnerRadiusExitWindow, ExternalRadiusExitWindow,
               ExitWindowThickness / 2., startAngleExitWindow, spanningAngleExitWindow);

  logicExitWindow = new G4LogicalVolume(solidExitWindow, WindowMaterial, "ExitWindow", 0, 0, 0);

  physicExitWindow = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(ExitWindowXPosition, ExitWindowYPosition, ExitWindowZPosition)),
    "ExitWindow", logicExitWindow, physicTreatmentRoom, false, 0);
...
void LaserDrivenBeamLine::ExitPipe()
{
  ...
  solidExitPipe = new G4Tubs("ExitPipe", InnerRadiusExitPipe, ExternalRadiusExitPipe,
                             ExitPipeheight / 2., startAngleExitPipe, spanningAngleExitPipe);

  logicExitPipe = new G4LogicalVolume(solidExitPipe, PipeMaterial, "ExitPipe", 0, 0, 0);

  physicExitPipe = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(ExitPipeXPosition, ExitPipeYPosition, ExitPipeZPosition)),
    "ExitPipe", logicExitPipe, physicTreatmentRoom, false, 0);
...
void LaserDrivenBeamLine::Exithole()
{
  ...
  solidExithole = new G4Tubs("Exithole", InnerRadiusExithole, ExternalRadiusExithole,
                             ExitholeThickness / 2., startAngleExithole, spanningAngleExithole);

  logicExithole = new G4LogicalVolume(solidExithole, internalChamberMaterial, "Exithole", 0, 0, 0);

  physicExithole = new G4PVPlacement(
    G4Transform3D(rm, G4ThreeVector(ExitholeXPosition, ExitholeYPosition, ExitholeZPosition)),
    "Exithole", logicExithole, physicExternalChamber, false, 0);
...
void LaserDrivenBeamLine::SetFirstCollimatorRadius(G4double valueR)
{
  ...
  G4cout << "The first collimator aperture has been modified to " << valueR / mm << "mm in diameter"
         << G4endl;
}
/////////////////////////////////////////////////////////////////////////////
...
void LaserDrivenBeamLine::SetFirstCollimatorThickness(G4double valueC)
{
  ...
  G4cout << "The first collimator thickness has been modified to " << valueC / mm
         << " mm in thickness" << G4endl;
}
...
void LaserDrivenBeamLine::SetFirstCollimatorPositionZ(G4double valueQ)
{
  ...
  G4cout << "The first collimator has been translated to " << valueQ / mm << "mm (along the z axis)"
         << G4endl;
}
...
void LaserDrivenBeamLine::SetSecondCollimatorRadius(G4double value)
{
  ...
  G4cout << "The second collimator aperture has been modified to " << value / mm << "mm in diameter"
         << G4endl;
}
...
void LaserDrivenBeamLine::SetSecondCollimatorThickness(G4double value)
{
  ...
  G4cout << "The second collimator thickness has been modified to " << value / mm
         << " mm in thickness" << G4endl;
}
...
void LaserDrivenBeamLine::SetSecondCollimatorPositionZ(G4double value)
{
  ...
  G4cout << "The second collimator has been translated to " << value / mm << "mm (along the z axis)"
         << G4endl;
}
// THE SLIT MESSENGERS
/////////////////////////////////////////////////////////////////////////////
...
void LaserDrivenBeamLine::SetThicknessSlit(G4double value)
{
  if (value > (10.0 * mm))
  {
    ...
    G4cout << "***************************************" << G4endl;
    G4cout << "The maximum value of the thickness of the slit is 10 mm, your value is >10 mm."
           << G4endl;
    G4cout << "The default thickness value is used, it is: "
           << ((solidExternalSlit->GetXHalfLength()) * 2.) / mm << G4endl;
    G4cout << "***************************************" << G4endl;
  }
  else
  {
...
void LaserDrivenBeamLine::SetSlitHoleDimensionY(G4double value)
{
  ...
  G4cout << "The hole of the Slit has been changed in the Y direction to " << value / mm << " mm"
         << G4endl;
}
...
void LaserDrivenBeamLine::SetSlitHoleDimensionZ(G4double value)
{
  ...
  G4cout << "The hole of the Slit has been changed in the Z direction to " << value / mm << " mm"
         << G4endl;
}
/////////////////////////////////////////////////////////////////////////////
...
void LaserDrivenBeamLine::SetSlitHolePositionZ(G4double value)
{
  ...
  G4cout << "The hole of the slit has been translated to " << value / mm << " mm (along the Z axis)"
         << G4endl;
}
...
void LaserDrivenBeamLine::RemoveQuads()
{
  ...
  if (pFieldMgrQuadFourth)
  {
    delete pFieldMgrQuadFourth;
  }
  if (pFieldMgrQuadThird)
  {
    delete pFieldMgrQuadThird;
  }
  if (pFieldMgrQuadSecond)
  {
    delete pFieldMgrQuadSecond;
  }
  if (pFieldMgrQuadFirst)
  {

...
class PassiveCarbonBeamLine : public G4VUserDetectorConstruction
{
  ...
  private:
    ...
    // BeamLine Envelope
    G4LogicalVolume* logicBeamLineBox;
    G4VPhysicalVolume* physicalBeamLineBox;
    ...
    G4Box* solidFirstMonitorLayer5;  // correction for Toshiba geometry
    G4LogicalVolume* logicFirstMonitorLayer5;  // correction for Toshiba geometry
    G4VPhysicalVolume* physiFirstMonitorLayer5;  // correction for Toshiba geometry
    ...
    G4Tubs* solidFinalCover;  // correction for Toshiba geometry
    G4VPhysicalVolume* physiFinalCover;  // correction for Toshiba geometry
    G4LogicalVolume* logicFinalCover;  // correction for Toshiba geometry
    ...
    G4double monitor4XSize;
    G4double monitor5XSize;
    G4double monitor1XPosition;
    G4double monitor2XPosition;
    G4double monitor3XPosition;
    G4double monitor4XPosition;
    G4double monitor5XPosition;
    ...
    G4double outerRadiusFinalCover;  // correction for Toshiba geometry
    G4double innerRadiusFinalCover;  // correction for Toshiba geometry
    G4double hightFinalCover;  // correction for Toshiba geometry
    G4double startAngleFinalCover;  // correction for Toshiba geometry
    G4double spanningAngleFinalCover;  // correction for Toshiba geometry
    G4double finalCoverXPosition;  // correction for Toshiba geometry
    ...
    G4Material* mylarNist;  // correction for Toshiba geometry
    G4Material* CFRPNist;  // correction for Toshiba geometry
    ...
    G4Material* layer5MonitorChamberMaterial;  // correction for Toshiba geometry
    ...
    G4Material* finalCoverMaterial;  // correction for Toshiba geometry

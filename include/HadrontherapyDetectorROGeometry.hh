...
class HadrontherapyDetectorROGeometry : public G4VUserParallelWorld
{
  public:
    ...
    void Initialize(G4ThreeVector detectorPos, G4double detectorDimX, G4double detectorDimY,
                    G4double detectorDimZ, G4int numberOfVoxelsX, G4int numberOfVoxelsY,
  ...
  private:
    ...
    G4LogicalVolume* RODetectorLV;
    G4LogicalVolume* RODetectorXDivisionLV;
    G4LogicalVolume* RODetectorYDivisionLV;
    G4LogicalVolume* RODetectorZDivisionLV;
    G4LogicalVolume* sensitiveLogicalVolume;

    // for lineal energy
    G4LogicalVolume* sensitiveSphereLV;

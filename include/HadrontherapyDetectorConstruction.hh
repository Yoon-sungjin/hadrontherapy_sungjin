...
public:
    ...
    // SD 부착을 위해 논리 체적 반환 함수 추가
    G4LogicalVolume* GetSensitiveSphereLV() const { return sensitiveSphereLV; }
    G4int GetNx() const { return numberOfVoxelsAlongX; }
    G4int GetNy() const { return numberOfVoxelsAlongY; }
...
private:
    ...
    std::vector<G4VPhysicalVolume*> spherePhysicalVolumes;
    G4LogicalVolume* envelopeSphereLV;
